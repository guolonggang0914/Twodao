...
public class NearbyActivity extends BaseActivity {
    ...
    private void initTablayout() {
        ...
        for (int i = 0; i < titles.size(); i++) {
            tabNearby.addTab(tabNearby.newTab().setText(titles.get(i)));//添加tab选项卡
        }
        mAdapter = new ContentPageAdapter(getSupportFragmentManager(), fragments, titles);
        tabNearby.setupWithViewPager(vpNearby);//将TabLayout和ViewPager关联起来。
        vpNearby.setAdapter(mAdapter);//给ViewPager设置适配器
    ...
    private void setMarker() {
        ...
        MapBiaoji mapBiaoji = new MapBiaoji(this);
